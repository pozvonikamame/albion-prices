...
const translations: Record<Language, TranslationDictionary> = {
  ru: {
    ...
    "bm.selectItems": "Выбрать предметы",
    "bm.searchItems": "Поиск оружия и брони…",
    "bm.weapons": "Оружие",
    "bm.armor": "Броня",
    "bm.categoriesLoading": "Загрузка категорий…",
    "bm.removeFilter": "Убрать из фильтра",
    "bm.tierAll": "Все тиры",
    "bm.enchantAll": "Все чары",
    "bm.foundItems": "Найдено",
    "bm.of": "из",
    "bm.notFound": "По запросу ничего не найдено",
    "bm.scanningTier": "Загружаем предметы T{tier}… прокрутите вниз или дождитесь окончания сканирования.",
    "bm.scanningFiltered": "Загружаем только отфильтрованные предметы…",
    "bm.buyPrice": "Цена выкупа",
    "bm.quality": "Качество",
    "bm.qualityAll": "Все качества",
    "bm.item": "Предмет",
    "bm.refresh": "Обновить",
  ...
  en: {
    ...
    "bm.selectItems": "Select items",
    "bm.searchItems": "Search weapons and armor…",
    "bm.weapons": "Weapons",
    "bm.armor": "Armor",
    "bm.categoriesLoading": "Loading categories…",
    "bm.removeFilter": "Remove from filter",
    "bm.tierAll": "All tiers",
    "bm.enchantAll": "All enchants",
    "bm.foundItems": "Found",
    "bm.of": "of",
    "bm.notFound": "Nothing found for your query",
    "bm.scanningTier": "Loading T{tier} items… scroll down or wait for the scan to finish.",
    "bm.scanningFiltered": "Loading filtered items only…",
    "bm.buyPrice": "Buy price",
    "bm.quality": "Quality",
    "bm.qualityAll": "All qualities",
    "bm.item": "Item",
    "bm.refresh": "Refresh",
